...
def Powered():
    Display.delete(0, END)
    Display.insert(0, 'Powered by Rohit...')
...
#===================================Main Screen==================================
txt_input = StringVar(value = '~~~Bingo services~~~ ')
...
txtCountry['values'] = ('China','France','Ghana','Mexico','Nigeria','USA','India')
...
#========================================Logo=======================================================
photo = PhotoImage(file='bingo.png')
